...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $datePicker= $_POST['datePicker2'];
    $start_time= $_POST['datePicker2'] ." ". $_POST['startTime2'];
    $end_time= $_POST['datePicker2'] ." ". $_POST['endTime2'];
    $approved_by = $_POST['approved_by2'];
    ...
    if ($dbUtil->createTableEntry($user_id, $project_name, $task_name, $start_time, $end_time, $approved_by)) {
        echo 'Das Projekt wurde erfolgreich angelegt';
        ...
        echo 'Fehler beim Anlegen des Projekts';
    }
    exit();
}
